...
class Scratch3RabboniBlocks {
    constructor (runtime) {
        log.info('VERSION AT 2022.3.5');
        /**
...
module.exports = Scratch3RabboniBlocks;